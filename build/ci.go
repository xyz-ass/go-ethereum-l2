...
import (
	...
	"github.com/xyz-ass/go-ethereum-l2/crypto/signify"
	"github.com/xyz-ass/go-ethereum-l2/internal/build"
...
func buildFlags(env build.Environment, staticLinking bool, buildTags []string) (flags []string) {
	var ld []string
	if env.Commit != "" {
		ld = append(ld, "-X", "github.com/xyz-ass/go-ethereum-l2/internal/version.gitCommit="+env.Commit)
		ld = append(ld, "-X", "github.com/xyz-ass/go-ethereum-l2/internal/version.gitDate="+env.Date)
	}
